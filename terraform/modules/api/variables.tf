...
variable "search_max_distance" {
  type        = number
  default     = 0.6
  description = "Maximum cosine distance for a description vector-search result to count as a match. Results beyond this are filtered out (lower = closer). Tune per environment/dataset."
}
